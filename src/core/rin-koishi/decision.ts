...
import { commandNameFromText, directLike, getChatId, getIncomingText, isCommandText, mentionLike, pickUserId, safeString } from './chat-helpers.js'
...
export async function shouldProcessText(session: any, identity: any, registeredCommands: Set<string>) {
