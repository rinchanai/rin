...
export function buildAllowedCommandRows(rpcCommands: Array<{ name: string; description?: string }>) {
...
export async function drainKoishiOutbox(app: any, agentDir: string, h: any, logger: any) {
