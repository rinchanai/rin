...
export function readRuntimeBootstrapState(stateRoot: string) {
  return readJsonFile<any>(runtimeBootstrapStateFileForState(stateRoot), null);
}
export function writeRuntimeBootstrapState(stateRoot: string, value: any) {
  writeJsonAtomic(runtimeBootstrapStateFileForState(stateRoot), value);
}
export function readInstanceState(stateRoot: string, instanceId: string) {
  return readSidecarInstanceState<any>(
    instanceStateFileForState(stateRoot, instanceId),
  );
}
export function listInstanceIds(stateRoot: string) {
...
export function removeInstanceState(stateRoot: string, instanceId: string) {
  try {
