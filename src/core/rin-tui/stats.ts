import { calculateContextTokens, estimateContextTokens } from './session-helpers.js'
...
export function computeSessionStats(model: any, sessionFile: string | undefined, sessionId: string, entries: any[], contextUsage: any) {
  let userMessages = 0
...
export function reconcilePendingQueues(steeringMessages: string[], followUpMessages: string[], targetCount: number) {
