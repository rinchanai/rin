import { createTargetExecutionContext, ensureDaemonAvailable, ParsedArgs, requireTool } from './shared.js'

function tryManagedServiceAction(context: ReturnType<typeof createTargetExecutionContext>, action: 'start' | 'stop' | 'restart') {
