...
export default function selfImproveExtension(pi: ExtensionAPI) {
  pi.registerTool({
    ...
    promptGuidelines: [
      ...
      "Use save_prompts only for compact long-lived prompt content; do not store task progress, session outcomes, or temporary state with save_prompts. When revising a slot with save_prompts, you may remove outdated, overly specific, or no-longer-durable lines to keep the baseline converged.",
    ],
