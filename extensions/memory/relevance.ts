...
export function excerptForRecall(doc: MemoryDoc, query: string, max = 240): string {
...
export function relationScore(a: MemoryDoc, b: MemoryDoc): { score: number, reason: string } {
