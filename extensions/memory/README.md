...
- recent-session previews favor actionable entries such as assistant steps, task anchors, tool activity, commands, paths, and unresolved blockers instead of generic chatter
