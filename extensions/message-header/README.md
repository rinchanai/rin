...
- for chat bridge messages, also includes chatKey, chat name, sender user id, nickname, and bridge identity
- for chat bridge messages, appends system-prompt guidance exposing the current chatKey/chat name and requiring plain-text replies without Markdown
