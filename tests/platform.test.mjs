...
const fsMod = await import(pathToFileURL(path.join(rootDir, 'dist', 'core', 'platform', 'fs.js')).href)
const processMod = await import(pathToFileURL(path.join(rootDir, 'dist', 'core', 'platform', 'process.js')).href)
