...
This is the minimal GUI host/runtime and installer-planning/apply substrate for issue #85. It does not replace OAuth/browser-login orchestration, terminal privilege prompts for cross-user writes, target-user Windows service parity, or packaged desktop shell yet; those build on top of this shared frontend boundary.
